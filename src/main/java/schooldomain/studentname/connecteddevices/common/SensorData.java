...
public class SensorData {
	...
	private String name;
	/*
	 * Parameterized Constructor to initialize a Sensor Data object
	 * @param maxVal indicates the maximum sensor Value
	 * @param minVal indicates the minimum sensor Value
	 * @param time  indicates the time
	 * @param name indicates the sensor name
	 */
	 ...
	 * 
	 * This getter nethod is used to get the count of the iterations
	 * @return sampleCount
	 */
	...
	/**
	 * This setter method is used to set the sample count value
	 * @param sampleCount indicates the count of iterations
	 */
	...
	/**
	 * This getter nethod is used to return the sample average value
	 * @return avgVal
	 */
