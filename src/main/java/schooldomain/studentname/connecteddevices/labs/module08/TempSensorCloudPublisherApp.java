...
/*
 * This TempSensorCloudPublisherApp sends data via HTTPS to the cloud
 */
public class TempSensorCloudPublisherApp {
	...
	public String generateRandomvalue(float min, float max) {
		...
		System.out.println("\nValue : " + Float.toString(random));
		return Float.toString(random);
	}

	public static void main(String[] args) {
		final String UBIDOTS_PATH_SEPERATOR = "/";
		final String UBIDOTS_VARIABLE_LABEL = "TempSensor";
		...
		String _authToken = "A1E-bTYcPH9gTqVm4CfXvUPay1nzCHTnie";
		float min = 0f;
		float max = 45f;
		...
		try {
			...
			while (true) {
				Jobj.put(UBIDOTS_VARIABLE_LABEL, TSCPA.generateRandomvalue(min, max));
